...
local debugger = require("extensions.NakamaX4Client.ui.nakama.debugger")
...
local function Load_Dll()
    ...
    local lib, err = package.loadlib(dll_path, "luaopen_log_to_x4")
    
    if lib then
        DebugError("[Nakama] DLL loaded successfully, calling luaopen_log_to_x4")
